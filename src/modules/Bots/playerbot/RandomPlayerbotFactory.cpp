...
void RandomPlayerbotFactory::CreateRandomBots()
{
    ...
    accountExpansion = 2;
#endif
    LoginDatabase.PExecute("UPDATE account SET expansion = '%u' where username like '%s%%'", accountExpansion, sPlayerbotAIConfig.randomBotAccountPrefix.c_str());
