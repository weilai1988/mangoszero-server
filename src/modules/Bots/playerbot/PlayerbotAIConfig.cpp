...
bool PlayerbotAIConfig::Initialize()
{
    ...
    lowHealth = config.GetIntDefault("AiPlayerbot.LowHealth", 60);
    mediumHealth = config.GetIntDefault("AiPlayerbot.MediumHealth", 80);
    almostFullHealth = config.GetIntDefault("AiPlayerbot.AlmostFullHealth", 92);
