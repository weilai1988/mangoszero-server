...
namespace ai
{
    ...
    public:
        ChatActionContext()
        {
            ...
            creators["grouprefresh chat shortcut"] = &ChatActionContext::party_buffs_chat_shortcut;
            creators["brain status chat shortcut"] = &ChatActionContext::brain_status_chat_shortcut;
    ...
    private:
        ...
        static Action* party_buffs_chat_shortcut(PlayerbotAI* ai) { return new PartyBuffsChatShortcutAction(ai); }
        static Action* brain_status_chat_shortcut(PlayerbotAI* ai) { return new BrainStatusChatShortcutAction(ai); }
